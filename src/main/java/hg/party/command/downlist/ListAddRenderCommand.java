...
@Component(
		...
		property = {
			...
			"mvc.command.name=/asset/addDeviceRender"
	    },
	    service = MVCRenderCommand.class
	)
public class ListAddRenderCommand implements MVCRenderCommand {
	Logger logger = Logger.getLogger(ListAddRenderCommand.class);
	@Reference
