...
@Component(
		...
		property = {
			...
			"mvc.command.name=/PartyWriteActionOrgCommand"
	    },
	    service = MVCResourceCommand.class
)
public class PartyWriteActionOrgCommand implements MVCResourceCommand{
	
	Logger logger = Logger.getLogger(PartyWriteActionOrgCommand.class);
	@Reference
...
//					meetingN.setImage(image);
					meetingN.setMeeting_state_org(meeting_state);
					meetingN.setRemarks_org(remarks);
					meetingN.setImage_org(image);
