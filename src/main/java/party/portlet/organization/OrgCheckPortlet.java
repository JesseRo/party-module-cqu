...
@Component(
		...
		property = {
			...
			"javax.portlet.display-name=组织部-抽查页面",
			"javax.portlet.init-param.template-path=/",
			"com.liferay.portlet.requires-namespaced-parameters=false",
			"javax.portlet.init-param.view-template=/jsp/organization/orgcheck.jsp",
...
public class OrgCheckPortlet extends MVCPortlet{
