...
//			filename = organization.getOrg_name();
            ...
            if (type.equalsIgnoreCase("org")) {
                ...
                for (Organization organization : orgTree) {
                    ...
                    jsonObject.put("secretary", organization.getOrg_secretary());
                    jsonObject.put("contact", organization.getOrg_contactor());
                    jsonObject.put("phoneNumber", organization.getOrg_phone_number());
                    jsonObject.put("orgDesc", ConstantsKey.ORG_DESC_MAP.get(organization.getDesc_type()));
                    ja.add(jsonObject);
                }
                Map<String, String> headMap = new LinkedHashMap<>();
                headMap.put("fullName", "党组织名称");
                headMap.put("name", "党组织简称");
                headMap.put("secretary", "党组织书记");
