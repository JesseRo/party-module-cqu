...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=领导参会情况统计列表",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsp/member/leaderStatistics.jsp",
...
public class LeaderStatisticsPortlet extends MVCPortlet {
