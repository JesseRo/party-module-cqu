...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationRecommendName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/recommend.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationRecommend,
...
// 党支部积极分子推荐
public class BrunchRecommendPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationRecommend);
