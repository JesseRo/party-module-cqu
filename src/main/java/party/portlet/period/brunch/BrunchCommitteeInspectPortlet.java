...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationCommitteeInspectName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/committeeInspect.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationCommitteeInspect,
...
// 支部委员会审查
public class BrunchCommitteeInspectPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationCommitteeInspect);
