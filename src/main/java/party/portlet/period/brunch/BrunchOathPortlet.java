...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationOathName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/oath.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationOath,
...
// 入党宣誓
public class BrunchOathPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationOath);
