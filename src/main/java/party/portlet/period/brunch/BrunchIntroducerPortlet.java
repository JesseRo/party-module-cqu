...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationIntroducerName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/introducer.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationIntroducer,
...
// 确定介绍人
public class BrunchIntroducerPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationIntroducer);
