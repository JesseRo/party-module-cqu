...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationConferenceDiscuss4Name,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/conferenceDiscuss4.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationConferenceDiscuss4,
...
// 支部大会讨论
public class BrunchConferenceDiscuss4Portlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationConferenceDiscuss4);
