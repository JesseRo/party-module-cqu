...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.BrunchApplicationTogetherStudyName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/brunch/togetherStudy.jsp",
                "javax.portlet.name=" + PeriodKeys.BrunchApplicationTogetherStudy,
...
// 开展集中培训
public class BrunchTogetherStudyPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.BrunchApplicationTogetherStudy);
