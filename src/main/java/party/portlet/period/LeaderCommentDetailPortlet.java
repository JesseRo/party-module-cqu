...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.LeaderApplicationCommentDetailName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/leader/commentDetail.jsp",
                "javax.portlet.name=" + PeriodKeys.LeaderApplicationCommentDetail,
                "javax.portlet.resource-bundle=content.Language",
                "javax.portlet.security-role-ref=power-user,user"
        },
        service = Portlet.class
)
public class LeaderCommentDetailPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.LeaderApplicationCommentDetail);
