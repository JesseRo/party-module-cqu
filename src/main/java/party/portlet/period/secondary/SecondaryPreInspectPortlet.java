...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.SecondaryApplicationPreInspectName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/secondary/preInspect.jsp",
                "javax.portlet.name=" + PeriodKeys.SecondaryApplicationPreInspect,
...
// 接受预审
public class SecondaryPreInspectPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.SecondaryApplicationPreInspect);
