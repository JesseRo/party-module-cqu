...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.SecondaryApplicationInspectName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/secondary/inspect.jsp",
                "javax.portlet.name=" + PeriodKeys.SecondaryApplicationInspect,
...
// 发展对象考察
public class SecondaryInspectPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.SecondaryApplicationInspect);
