...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.SecondaryApplicationJoinApprovalName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/secondary/joinApproval.jsp",
                "javax.portlet.name=" + PeriodKeys.SecondaryApplicationJoinApproval,
...
// 转正审批
public class SecondaryJoinApprovalPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.SecondaryApplicationJoinApproval);
