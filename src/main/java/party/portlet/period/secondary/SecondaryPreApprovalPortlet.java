...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.SecondaryApplicationPreApprovalName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/secondary/preApproval.jsp",
                "javax.portlet.name=" + PeriodKeys.SecondaryApplicationPreApproval,
...
// 预备党员审批
public class SecondaryPreApprovalPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.SecondaryApplicationPreApproval);
