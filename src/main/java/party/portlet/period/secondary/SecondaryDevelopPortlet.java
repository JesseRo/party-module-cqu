...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.SecondaryApplicationDevelopName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/secondary/develop.jsp",
                "javax.portlet.name=" + PeriodKeys.SecondaryApplicationDevelop,
...
// 积极分子培养
public class SecondaryDevelopPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.SecondaryApplicationDevelop);
