...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.PersonApplicationsName,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/person/view.jsp",
...
public class PersonPeriodPortlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.PersonApplications);
