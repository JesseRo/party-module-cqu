...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.PersonApplicationsName3,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/person/view3.jsp",
                "javax.portlet.name=" + PeriodKeys.PersonApplications3,
                "javax.portlet.resource-bundle=content.Language",
                "javax.portlet.security-role-ref=power-user,user"
        },
        service = Portlet.class
)
public class PersonPeriod3Portlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.PersonApplications3);
