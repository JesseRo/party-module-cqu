...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=" + PeriodKeys.PersonApplicationsName2,
                "javax.portlet.init-param.template-path=/",
                "com.liferay.portlet.requires-namespaced-parameters=false",
                "javax.portlet.init-param.view-template=/jsp/period/person/view2.jsp",
                "javax.portlet.name=" + PeriodKeys.PersonApplications2,
                "javax.portlet.resource-bundle=content.Language",
                "javax.portlet.security-role-ref=power-user,user"
        },
        service = Portlet.class
)
public class PersonPeriod2Portlet extends MVCPortlet {
    @Reference
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
        ...
        Period period = periodDao.findByName(PeriodKeys.PersonApplications2);
