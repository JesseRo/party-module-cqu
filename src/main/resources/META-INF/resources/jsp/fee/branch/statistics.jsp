        ...
        $(function() {
            ...
            layui.use('table', function(){
                ...
                tableObj = table.render({
                    elem: '#feeTable',
                    url: sessionStorage.getItem("feeUrl") + '/fee/branch/statistics', //数据接口
                    ...
                    cols: [[ //表头
                        ...
                        {field: 'year', title: '年份/月份', width:'9%', templet: function (d) {
                                ...
                                return d[-1] ? '<a onclick="window.location.href=\'/year_statistics?year=' + d[-1] + '\'">' + d[-1] + '</a>' : '合计';
                            }},
                        // {field: 'member', title: '党员人数', width:'6.5%', templet: function (d) {
                        //         return d[0] || '';
                        //     }},
