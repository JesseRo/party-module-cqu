     ...
     $(function(){
    	   ...
    	   function detail(members){
               ...
               for(var i in members){
                   ...
                   html += " <tr>\n" +
                       "                                <td style=\"text-align:left;padding-left:10px;\"><input type=\"hidden\" value=\""+ member.member_identity +"\"> <img class=\"clickImg\" src=\"/images/not_check_icon.png\">"+  member.member_name +"</td>\n" +
    ...
    <div class="min_width_1200">
          <div class="nav_list">
              ...
              <ul class="party_organization_list">
                  <li id="current_root" class="root" style="width: 300px;">
          ...
          <div class="content_form content_info">
              <div class="content_title hidden-xs">
                	<span id="title">人员详情</span>  
                  <div class="btn_group">
                       <div class="select_choice" style="padding-top: 7px;">
