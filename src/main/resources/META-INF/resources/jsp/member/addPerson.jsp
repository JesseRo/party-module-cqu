           	...
           	<form class="form-horizontal" id="addPersonForm" role="form" action="${addUser }" method="post">
	               ...
	               <div class="col-sm-6 col-xs-12">
	                    ...
	                    <div class="col-sm-9 col-xs-9" style="width: 75%;line-height: 34px;">
							  ...
							  <input type="text" class="form-control" readonly  name="birth_place" id="birth_place" value="${info.member_birth_place }"> 
	                    </div>
	                </div>     
	               ...
	               <!--  
	                 <div class="col-sm-6 col-xs-12">
	                   ...
	                   <div class="col-sm-6 col-xs-12">
	                    ...
	                    <div class="col-sm-9 col-xs-9">
	                        <input type="text" class="form-control" placeholder="手机号码" name="telephone" id="telephone" value="${info.member_phone_number }" >
	                    </div>
	                </div>
	                   <div class="col-sm-6 col-xs-12">
	                    <span class="col-sm-3 col-xs-3 control-label form-label-required">身份证号</span>
	                    <div class="col-sm-9 col-xs-9">
	                        <input type="text" class="form-control"  name="ID_card" id="ID_card" value="${info.member_identity }">
	                    </div>
	                </div> 
	                 ...
	                 <div class="col-sm-6 col-xs-12">
	                  ...
	                  <div class="col-sm-6 col-xs-12">
	                    ...
	                    <div class="col-sm-9 col-xs-9">
	                        <input type="text" class="form-control"  name="home_addrss" id="home_addrss" value="${info.member_address }">
	                    </div>
	                </div> 	
	                 <div class="col-sm-6 col-xs-12">
	                ...
	                <div class="col-sm-6 col-xs-12">
	                    <span class="col-sm-3 col-xs-3 control-label form-label-required">党费标准（元/月）</span>
	                    <div class="col-sm-9 col-xs-9">
	                        <input type="text" class="form-control"  name="major_title" id="major_title" onblur="check(this)"  onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" value="${info.member_major_title }">
	                    </div>
	                </div>
