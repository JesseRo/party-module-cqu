...
<div class="table_form_content">
    ...
    <div class="activity_manage_page">
        ...
        <div class="content_form" style="padding: 20px 0;">
            <form class="form-horizontal" role="form" action="${uploadMeetingNotesUrl}" method="post"
                  enctype="multipart/form-data" style="width: 960px;">
                <div id="hg-form-container" class="form-group">
                    ...
                    <div class="table_info" style="display: none;">
                        <a class="template">
                            会议记录模板下载
                            <input type="hidden" class="imageNeme" value="/templates/MeetingTemplates.doc"
                                   name="imageNeme"/>
                        </a>
                    </div>
<%--                    <div class="btn_group col-sm-12">--%>
<%--                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="formsubmitgraft()" style="margin-left: 14%;padding: 6px 20px;">取消--%>
<%--                        </button>--%>
<%--                        <button type="button" class="btn btn_main add_sure_btn" style="margin-left: 10px;color:white; background-color: #5161FF;padding: 6px 20px;"--%>
