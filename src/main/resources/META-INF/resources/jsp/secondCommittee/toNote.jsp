                ...
                <table class="layui-table custom_table" >
                    ...
                    <c:forEach var="c" items="${informMeetingList}" varStatus="status">
                        <tr class="oneinfo" id="${c.inform_id }">
                            ...
                            <td data-label="时长"  style="width:70px;">
                                    ${c.total_time / 60}
                            </td>
                            <td data-label="状态" style="width:120px;">
...
<%--                                </c:if>--%>
                            ...
                            <td style="width:120px;">
                                <c:if test="${c.task_status ge 4 && empty c.noteId}">
                                    <a onclick="window.location.href='/uploadnotes?meetingId=${c.meeting_id}'" href="javascript:;">会议纪要</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
