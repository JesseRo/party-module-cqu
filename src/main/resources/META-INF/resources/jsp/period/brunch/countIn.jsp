    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">编入党支部和党小组</h4>
            </div>
            <div class="modal-body" >
             <div class="col-sm-6 col-xs-12">
                ...
                <select style="width: 200px;">
                    <option></option>
                    <option>xx学院学生一支部第一小组</option>
                    <option>xx学院学生一支部第二小组</option>
                </select>
            </div>
                <div class="col-sm-6 col-xs-12">
                    <label>党支部:</label>
                    <select style="width: 200px;" disabled>
                        <option>xx学院学生一支部</option>
                    </select>
                </div>
                ...
                <table class="content_table" style="border:1px solid #dedede;">
                    ...
                    <tbody class="table_info">
                        ...
                        <tr>
                                        ...
                                        <c:if test="${ct == 'true'}">
                                            ...
                                            <div>
                                                <div class="approve" style="display: none;">
                                                    <a class="approval" style="cursor: pointer;">是</a>
                                                    <a class="reject" style="cursor: pointer;">否</a>
                                                </div>
                                                <div class="pass" style="display: none;">已编入</div>
                                            ...
                                            <button data-toggle="modal" data-target="#myModal" type="button" class="btn btn-default col-xs-4 btn-commu" style="width: 50%;">
                                                <img src="/images/import_icon.png"> 编入
                                            </button>
                            ...
                            <td>
                                <a href="/images/test.doc">下载谈话结果</a>
                            </td>
                        </tr>　
　　                     </c:forEach>
                    </tbody>
