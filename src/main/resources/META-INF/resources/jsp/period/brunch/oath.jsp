                            ...
                            <c:forEach var="ct" items="${c}" varStatus="vs">
                                <c:choose>
                                    ...
                                    <td>
                                        <c:if test="${ct == 'true'}">
                                            <div>
                                                <button id="import" type="button" class="btn btn-default col-xs-4" style="width: 70%">
                                                    <img src="/images/import_icon.png"> 宣誓仪式记录
                                                </button>
                                                ...
                                                <a id="download" href="/images/test.doc" style="line-height: 30px; display:none;">下载记录</a>
                                            <div>
