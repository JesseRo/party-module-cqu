    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">集中培训时间</h4>
            </div>
            <div class="modal-body" style="display: flex;"><input style="width: 100px;"><p style="line-height: 25px;">小时</p></div>
                ...
                <table class="content_table" style="border:1px solid #dedede;">
                    ...
                    <tbody class="table_info">
                        ...
                        <tr>
                                ...
                                <c:choose>
                                    ...
                                    <td>
                                        <c:if test="${ct == 'true'}">
                                            ...
                                            <button data-toggle="modal" data-target="#myModal" type="button" class="btn btn-default col-xs-4 btn-commu" style="width: 75%;">
                                                <img src="/images/import_icon.png"> 设定培训时间
                                            </button>
                            ...
                            <td>
                                <a href="/images/test.doc">下载政治审查结果</a>
                            </td>
                        </tr>　
　　                     </c:forEach>
                    </tbody>
