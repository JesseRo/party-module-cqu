...
$(function(){
    ...
    $("#checkState option").each(function(){
    	if($(this).attr("value") == checkState){
	            ...
	            <portlet:resourceURL id="/hg/orgCheckCountExport" var="orgCheckCountExport"/>
	          	<div class="btn_group">
	                ...
	                <span  style="float:right;">	      
	                	<a href="${orgCheckCountExport }&meetType=${meetType}&meetTheme=${meetTheme}&branchId=${branchId}&seconedId=${seconedId}&startTime=${startTime}&endTime=${endTime}&checkState=${checkState}" > 
				...
				<div class="pagination_container">
			        ...
			        <div class="pageJump">
			            ...
			            <portlet:actionURL name="/PageNoMVCActionCommand" var="pageNoUrl">
			            	...
			            	<portlet:param name="checkState" value="${checkState }"/>
						</portlet:actionURL>
