...
<html>
	...
	<body class="front">
	<input type="hidden" class="orgType" value="${orgType }">
		<div class="content_title" style="margin-bottom:30px;">
        	<a href="/passpublic" style="color: #ce0000;">已发布</a>>
        	<a href="/sconedpartydetail?inform_id=${informId }" style="color: #ce0000;">二级党组织活动进度</a>>党支部活动进度  
        </div>
                    ...
                    <tbody class="table_info" id="tBody">
                   	    <c:forEach items="${list}" var="c" varStatus="status">
	                        <tr>
	                            ...
	                            <td data-label="开展时间" class="PublishTime">
...
<!--                 </div> -->
	...
	<portlet:resourceURL id="/hg/findCheckState" var="findCheckState"/>
    ...
    <script type="text/javascript">
        ...
        $(".td_assign_btn").click(function() {
            ...
            if($(this).text()=="抽查" && $(".orgType").val()=="organization"){                         
	           var url= "${findCheckState}";
	           var dataMessages;
	           $.ajax({
	             url:url,
	             data:{id:id},
                 ...
                 if(dataMessages.state==true){
                  var isContinue = confirm("已经抽查："+dataMessages.messages+"次");
                     if(!isContinue){
                      return; 
                     }
                  }
