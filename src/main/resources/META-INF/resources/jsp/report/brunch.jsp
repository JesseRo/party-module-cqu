                    ...
                    <div id="hg-form-container" class="form-group">
                            ...
                            <div class="col-sm-12 col-xs-12" style="margin-bottom: 20px;">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="col-sm-6 col-xs-6 ">
                                        <span class="control-label form-label-required"
                                               style="line-height:40px;word-break: normal;word-wrap: break-word;padding-top: 0;">${f.fileName}：</span>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                        ...
                        <div class="layui-inline btn_group"
                            ...
                            <div class="layui-input-inline">
                                <button id="send" type="button" class="layui-btn" lay-submit=""
                                ...
                                <button id="cancel" onclick="window.history.back();" type="button"
