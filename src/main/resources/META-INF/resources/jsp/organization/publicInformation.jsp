...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#hg-form-container > div").eq(2).replaceWith(div);
            $("#hg-form-container > div").eq(2).find(".control-label").addClass("form-label-required");
            $.ajax({
                url: '${getPublicObject}',
                type: 'POST',
                data: "",
            ...
            if (infromData) {
                ...
                if (c.enable_comment == 't') {
                    $("select[name='isComment'] option:eq(1)").prop("selected", 'selected');
                }
                if (c.enable_comment == 'm') {
                    $("select[name='isComment'] option:eq(3)").prop("selected", 'selected');
                }
                if (c.enable_comment == 'f') {
                    $("select[name='isComment'] option:eq(2)").prop("selected", 'selected');
                }
